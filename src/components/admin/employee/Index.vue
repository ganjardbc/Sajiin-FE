                    ...
                    <div class="display-flex space-between" style="padding-top: 5px; padding-bottom: 5px;">
                        <div style="width: 60px; margin-right: 15px;">
                            <div class="image image-padding border border-full">
                                <VueLoadImage v-if="dt.employee.image">
                                    <img slot="image" :src="employeeImageThumbnailUrl + dt.employee.image" alt="" class="post-center">
                                    <div slot="preloader">
                        ...
                        <div class="display-flex row space-between" style="width: 40px;">
                            <AppButtonMenu 
                                :onChange="(data) => onChangeMenuOwner(data, dt.employee.id)" 
                                :data="[
...
export default {
    ...
    methods: {
        ...
        async removeData () {
            ...
            const id = this.onSearchData(this.selectedIndex).employee.employee_id
            const payload = {
                employee_id: id
            }
