    ...
    <div id="FormEmployee">
        ...
        >
            <div style="overflow-x: auto;">
                <table>
                    <thead>
                        <th class="normal-col">EMPLOYEE ID</th>
                        <th>NAME</th>
                    ...
                    <tbody>
                        <tr v-for="(dt, index) in datas" :key="index">
                            <td class="normal-col">{{ dt.employee.employee_id }}</td>
                            <td>{{ dt.employee.name }}</td>
                            <td class="normal-col">{{ dt.employee.phone }}</td>
                            <td class="small-col">
                                <button v-if="data.id !== dt.employee.id" class="btn btn-small-icon btn-sekunder" @click="onChoose(dt.employee)">
