            ...
            <div class="bg-white">
                <div class="display-flex space-between" style="padding-bottom: 15px;">
                    ...
                    <div class="display-flex">
                        ...
                        <SearchField :placeholder="'Search positions ..'" :enableResponsive="true" style="margin-left: 5px;" />
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async removeData () {
            ...
            const id = this.onSearchData(this.selectedIndex).position_id
            const payload = {
                position_id: id
            }

            const rest = await axios.post('/api/position/delete', payload, { headers: { Authorization: token } })
        ...
        async saveData () {
            ...
            const url = this.formTitle === 'CREATE' ? '/api/position/post' : '/api/position/update' 
        ...
        async uploadImage (data) {
            ...
            const url = '/api/position/uploadImage' 
        ...
        async removeImage () {
            ...
            const token = 'Bearer '.concat(this.$cookies.get('token'))
            const payload = this.selectedData
            const url = '/api/position/removeImage' 
