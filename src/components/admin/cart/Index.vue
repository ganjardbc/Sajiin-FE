            ...
            <div class="bg-white box-shadow">
                <div class="display-flex row space-between padding padding-10-px" style="height: 40px;">
                    ...
                    <div class="display-flex">
                        ...
                        <SearchField :placeholder="'Search carts ..'" :enableResponsive="true" style="margin-left: 5px;" />
                    </div>
                </div>
                            ...
                            <div class="display-flex space-between" style="padding-top: 5px; padding-bottom: 5px;">
                                ...
                                <div style="width: calc(100% - 185px);">
                                    <div class="display-flex" style="margin-bottom: 5px;">
                                        <div class="fonts fonts-11 semibold" style="margin-top: 3px;">{{ dt.product_name }}</div>
                                    </div>
                                    <div class="display-flex">
...
export default {
    ...
    methods: {
        ...
        async saveData () {
            ...
            const url = this.formTitle === 'CREATE' ? '/api/cart/post' : '/api/cart/update' 
        ...
        async uploadImage (data) {
            ...
            const url = '/api/cart/uploadImage' 
        ...
        async removeImage () {
            ...
            const token = 'Bearer '.concat(this.$cookies.get('token'))
            const payload = this.selectedData
            const url = '/api/cart/removeImage' 
