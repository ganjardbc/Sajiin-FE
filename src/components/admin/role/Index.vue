        ...
        <div class="left">
            <div class="bg-white">
                <div class="display-flex row space-between border-bottom padding padding-10-px" style="height: 40px;">
                    <div>
                        <h1 class="fonts small black">ROLES</h1>
                    ...
                    <div class="display-flex">
                        <AppButtonMenu 
                            ...
                            :data="[{label: 'By ID'}, {label: 'By Role Name'}, {label: 'By Status'}]" />
                        <button class="btn btn-white btn-icon btn-radius" @click="onShow('CREATE')">
                            <i class="fa fa-lw fa-plus" />
                        </button>
                        <SearchField :placeholder="'Search roles ..'" :enableResponsive="true" style="margin-left: 5px;" />
                    </div>
                </div>
                ...
                <div class="table-container">
                    <v-table 
                        ...
                        <thead slot="head">
                            ...
                            <v-th sortKey="role_id">Role ID</v-th>
                            <v-th sortKey="role_name">Role Name</v-th>
...
export default {
    ...
    methods: {
        ...
        async removeData () {
            ...
            const id = this.onSearchData(this.selectedIndex).role_id
            const payload = {
                role_id: id
            }
        ...
        async saveData () {
            ...
            const url = this.formTitle === 'CREATE' ? '/api/role/post' : '/api/role/update' 
