                ...
                <div class="display-flex row space-between border-bottom padding padding-10-px" style="height: 40px;">
                    ...
                    <div class="display-flex">
                        <AppButtonMenu 
                            ...
                            :data="[{label: 'By ID'}, {label: 'By Key'}, {label: 'By Value'}]" />
                        <button class="btn btn-white btn-icon btn-radius" @click="onShow('CREATE')">
                            <i class="fa fa-lw fa-plus" />
                        </button>
                        <SearchField :placeholder="'Search bizpars ..'" :enableResponsive="true" style="margin-left: 5px;" />
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async removeData () {
            ...
            const rest = await axios.post('/api/bizpar/delete', payload, { headers: { Authorization: token } })
        ...
        async saveData () {
            ...
            const url = this.formTitle === 'CREATE' ? '/api/bizpar/post' : '/api/bizpar/update' 
        ...
        async getData () {
            ...
            const rest = await axios.post('/api/bizpar/getAll', payload, { headers: { Authorization: token } })
