        ...
        <div class="left">
            <div class="bg-white box-shadow">
                <div class="display-flex row space-between padding padding-10-px" style="height: 40px;">
                    <div>
                        <h1 class="fonts small black">CATEGORIES</h1>
                    ...
                    <div class="display-flex">
                        ...
                        <SearchField :placeholder="'Search categories ..'" :enableResponsive="true" style="margin-left: 5px;" />
                    </div>
                </div>
                            ...
                            <div class="display-flex space-between" style="padding-top: 5px; padding-bottom: 5px;">
                                <div style="width: 60px; margin-right: 15px;">
                                    <div class="image image-padding border border-full">
                                        <img v-if="dt.image" :src="categoryImageThumbnailUrl + dt.image" alt="" class="post-center">
...
export default {
    ...
    methods: {
        ...
        async removeData () {
            ...
            const id = this.onSearchData(this.selectedIndex).category_id
            const payload = {
                category_id: id
            }
        ...
        async saveData () {
            ...
            const url = this.formTitle === 'CREATE' ? '/api/category/post' : '/api/category/update' 
        ...
        async uploadImage (data) {
            ...
            const token = 'Bearer '.concat(this.$cookies.get('token'))
            const payload = this.selectedData
            const url = '/api/category/uploadImage' 
        ...
        async removeImage () {
            ...
            const token = 'Bearer '.concat(this.$cookies.get('token'))
            const payload = this.selectedData
            const url = '/api/category/removeImage' 
