            ...
            feedback: [
                {
                    ...
                    quote: 'So many potential issues or simple fixes are lost in communication and I feel the systems we’re putting in place with Fleetio are building an excellent communication platform.',
                    name: 'Ian Lomax',
