<template>
    <div id="cart" class="main-screen">
        <AppMobileLayout :title="'Create Orders'">
                        ...
                        <div class="display-flex">
                            <div style="width: 50px; margin-right: 20px;">
                                <div class="image image-50px image-circle" style="text-align: center;">
                                    <i v-if="dataShop && !dataShop.image" class="post-center fa fa-lg fa-user-circle" style="color: #999;" />
                                    <img v-else :src="dataShop ? (shopImageThumbnailUrl + dataShop.image) : ''" alt="" class="post-center">
                                </div>
                            </div>
                            <div style="width: calc(100% - 70px);">
                                <div class="fonts fonts-11 semibold" style="margin-bottom: 5px;">{{ dataShop && dataShop.name ? dataShop.name : '-' }}</div>
                                <div class="display-flex" style="margin-bottom: 5px;">
                                    <div style="width: 25px;">
                                        <i class="far fa-lw fa-clock" style="font-size: 14px; color: #555;" />
                                    </div>
                                    <div class="fonts fonts-10 grey">{{ dataShop && dataShop.open_time ? dataShop.open_time : '-' }} - {{ dataShop && dataShop.close_time ? dataShop.close_time : '-' }}</div>
                                </div>
                                <div class="display-flex">
                                    <div style="width: 25px;">
                                        <i class="fa fa-lw fa-map-marker-alt" style="font-size: 14px; color: #555;" />
                                    </div>
                                    <div class="fonts fonts-10 grey">{{ dataShop && dataShop.location ? dataShop.location : '-' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border-full" style="padding: 10px; width: calc(100% - 20px);">
                            <div class="display-flex space-between">
                                ...
                                <div style="width: 40px;">
                                    <router-link :to="{name: 'visitor-chose-table'}">
                    ...
                    <div class="width width-100 margin margin-top-30-px">
                        ...
                        <div class="card border-full" style="padding: 10px; width: calc(100% - 20px);">
                            <div class="display-flex space-between">
                                ...
                                <div style="width: 40px;">
                                    <router-link :to="{name: 'visitor-chose-payment'}">
                                        <button class="btn btn-icon btn-main-reverse with-hover">
                                            <i class="fa fa-lg fa-arrow-right" />
                                        </button>
                                    </router-link>
...
export default {
    ...
    methods: {
        ...mapActions({
            ...
            resetCartList: 'cart/resetCartList',
        ...
        async onSaveOrder () {
            ...
            const rest = await axios.post('/api/public/createOrder', data)
        ...
        async saveNotif (title, subtitle) {
            ...
            const rest = await axios.post('/api/public/sendNotif', payload)
